...
class TestEntry {
   ...
   * This checks that the getValue method is working by checking it retrieved what we want.
   ...
   * This checks that the getSymbol method is working by checking it retrieved what we want.
   *
  ...
  void testSymbolNotEqual() throws BadTypeException {
    ...
    assertNotEquals(Symbol.MINUS, Entry.getSymbol()); // compares PLUS to MINUS
  }
   ...
   * This checks that the getString method is working by checking it retrieved what we want.
   *
   * @throws BadTypeException getValue method throws BadTypeException in Entry class
   */
  @Test
   ...
   * This checks that the getType method is working by checking it retrieved what we want.
   */
  @Test
  void testType() {
